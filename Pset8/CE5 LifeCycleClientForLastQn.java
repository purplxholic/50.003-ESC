...
public class LifeCycleClientForLastQn {
	public static void main(String[] args) throws Exception {
    	...
    	for (int i = 0; i < numberOfClients; i++) {
        	clients[i] = new Thread(new LifeClient2(n));
//        	if (i%2 ==0) clients[i] = new Thread(new LifeClient2(stopper));
        	clients[i].start();
        }
...
class LifeClient2 implements Runnable {
	private final BigInteger n;
	
	public LifeClient2 (BigInteger n) {
		this.n = n;
	}
