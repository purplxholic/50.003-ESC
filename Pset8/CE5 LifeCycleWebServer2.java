...
import sun.misc.Queue;
 //PART A 
public class LifeCycleWebServer2 {
    ...
    public static void main(String[] args) throws Exception {
		...
		while (true) { //part A of CE5 here , change to while true let it go and maybe have something else to detect  
			try {
	...
	protected static void handleRequest(Socket connection) {
		try {
			...
			if (fromClient.equals("4294967297")){ //for CE5 Part A
