...
public class PutTakeTest {
    ...
    protected final BoundedBufferWithSpec<Integer> bb;
    ...
    public PutTakeTest(int capacity, int npairs, int ntrials) {
        this.bb = new BoundedBufferWithSpec<Integer>(capacity);
    ...
    class Consumer implements Runnable {
        public void run() {
            try {
                ...
                takeSum.getAndAdd(sum); //sum of all the numbers i've taken 
                barrier.await();
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
