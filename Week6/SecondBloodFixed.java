...
class WDer2 extends Thread {
	...
	public void run () {
		synchronized (amount) { //one synchronized block amount is the lock. but it can actually be any object so as long as the object is shared among the different 
			//threads 
